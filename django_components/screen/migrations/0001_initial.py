...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(db_index=True, help_text='used in html head and H1 (you can use templating language)', max_length=127, unique=True, verbose_name='screen title')),
        ...
        migrations.AlterIndexTogether(
            name='screen',
            index_together={('comprehensive', 'title')},
        ),
        ...
        migrations.AlterIndexTogether(
            name='layout',
            index_together={('screen', 'component', 'block'), ('screen', 'component'), ('screen', 'component', 'block', 'order')},
        ),
    ]
