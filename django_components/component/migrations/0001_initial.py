    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(blank=True, help_text='Blank if type is TemplateView', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='component_set', to='contenttypes.ContentType', verbose_name='content type')),
            ],
            options={
